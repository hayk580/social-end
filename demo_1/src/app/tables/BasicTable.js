...
export class TimelineResource extends SampleBase {
  constructor() {
    ...
    this.ownerData = [
        { text: 'Nuard', id: 1, color: '#ea7a57', capacity: 20, type: '' },
        { text: 'Lia', id: 2, color: '#7fa900', capacity: 7, type: '' },
        { text: 'Grigor', id: 3, color: '#5978ee', capacity: 5, type: '' },
        { text: 'Hayk', id: 4, color: '#fec200', capacity: 15, type: '' },
        { text: 'Anna', id: 5, color: '#df5286', capacity: 25, type: '' },
        { text: 'Naina', id: 6, color: '#00bdae', capacity: 10, type: '' },
        { text: 'John', id: 7, color: '#865fcf', capacity: 20, type: ' ' },
...
onRenderCell(args) {
    ...
    if (args.elementType === 'emptyCells' && args.element.classList.contains('e-resource-left-td')) {
        ...
        target.innerHTML = '<div class="name">Staff</div>';
    }
}
onPopupOpen(args) {
    let data = args.data;
    ...
    return (<div className='schedule-control-section'>
        ...
        fields: {
            ...
            endTime: { title: 'To', name: 'EndTime' }
                        ...
                        <ResourcesDirective>
                            <ResourceDirective field='RoomId' title='workers' name='MeetingRoom' allowMultiple={true} dataSource={this.ownerData} textField='text' idField='id' colorField='color'>
                            </ResourceDirective>
                        </ResourcesDirective>
                        <ViewsDirective>
