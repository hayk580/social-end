        ...
        <div className="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
          ...
          <ul className="navbar-nav navbar-nav-right">
            <Dropdown alignRight as="li" className="nav-item d-none d-lg-block">
                ...
                + <Trans>ավելացնել դասընթաց</Trans>
                </Dropdown.Toggle>
                ...
                <Dropdown.Menu className="navbar-dropdown preview-list create-new-dropdown-menu">
                  ...
                  <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()} className="preview-item">
                    ...
                    <div className="preview-item-content">
                      <p className="preview-subject ellipsis mb-1"><Trans>Ծրագրավորման դասընթաց</Trans></p>
                    </div>
                  </Dropdown.Item>
                  <Dropdown.Divider />
                  <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()} className="preview-item">
                    ...
                    <div className="preview-item-content">
                      <p className="preview-subject ellipsis mb-1"><Trans>Ինժիներական դասընթաց</Trans></p>
                    </div>
                  </Dropdown.Item>
                  <Dropdown.Divider />
                  <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()} className="preview-item">
                    ...
                    <div className="preview-item-content">
                      <p className="preview-subject ellipsis mb-1"><Trans>Վիդեոդասեր</Trans></p>
                    </div>
                  </Dropdown.Item>
                  <Dropdown.Divider />
                  <p className="p-3 mb-0 text-center"><Trans>Այլ</Trans></p>
                </Dropdown.Menu>
              </Dropdown>
            ...
            <Dropdown alignRight as="li" className="nav-item">
              <Dropdown.Toggle as="a" className="nav-link cursor-pointer no-caret">
                <div className="navbar-profile">
                  ...
                  <p className="mb-0 d-none d-sm-block navbar-profile-name"><Trans>Haykoo</Trans></p>
