...
export class Course extends Component {
 ...
 const name = this.state.name;
  ...
  const  CourseData =  {
   ...
   axios.post("http://localhost:5000/course/create", CourseData )
   .then(res => {
   ...
   .catch(err => {
    ...
    componentDidMount() {
     ...
     axios.get("http://localhost:5000/getcourse/all")
     .then(res => {
  ...
  render () {
    ...
    const {handelDesc} = this;
    const {makeCourse} = this;
    return (
              ...
              <div className ="card-body">
                ...
                <Form.Group>
                  ...
                  <Form.Group>
                    ...
                    <Form.Control type="text" className ="form-control" id="exampleInput 1" placeholder=" "  onChange={handelDesc} />

                  </Form.Group>

                  <button  className ="btn btn-primary mr-2"  onClick={makeCourse}>Պահպանել</button>
              </div>
            </div>
          </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="d-flex">
                            ...
                            <span className="pl-2">{course.title}</span>
                          </div>
                        </td>
                        <td> 02312 </td>
                        <td> King Cobra </td>
