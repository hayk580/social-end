            ...
            if(groupImage != undefined)
{
            ...
            axios.post(BACKEND_SERVER_DOMAIN + '/course_module/create',groups, config)
            .then(function (response) {
...
else 
{
    ...
    return(
        <section className="create-post">
            <h6>Ավելացնել Դասընթացի մուդուլ</h6>
            <div className="col-lg-12 col-md-12 col-sm-12">
                
                               <label>Մուդուլի անունը</label>
                               <input className="form-control_homework" type="text" placeholder="" onChange={handleTitleText} name="title" value={groupTitile}/>
                            
                               <label>Դասերի քանակը</label>
                               <input className="form-control_homework" type="number" placeholder="" onChange={handleTitleText} name="title" value={groupTitile}/>
                           
                               <label>Շաբաթվա ընթացքում դասերի քանակ</label>
                               <input className="form-control_homework" type="number" placeholder="" onChange={handleTitleText} name="title" value={groupTitile}/>
