...
export default function CreateGroupPost({user, newPost}) {
            ...
            if(postImage != undefined)
{
            ...
            .then(function(response){
                ...
                axios.post(BACKEND_SERVER_DOMAIN + '/post/groupPost/' + group_id, posts, config)
                .then(function (response) {
