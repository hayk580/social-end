...
export default function CreateGroup({user, newGroup}) {
    ...
    axios.post(BACKEND_SERVER_DOMAIN + '/category/create',groups, config)
    .then(function (response) {
        history.go(0)
    ...
    return(
        <section className="create-post">
            <h6>Ավելացնել նոր կատեգորիա</h6>
            <div className="col-lg-5 col-md-12 col-sm-12">
                
                               <label>Վերագիր</label>
                               <input className="form-control_homework" type="text" placeholder="Վերագիր" onChange={handleTitleText} name="title" value={groupTitile}/>
            ...
            <div className="submit-btn" ref={showBtn}>
                <button className="btn btn-primary btn-sm" type="submit" ref={btnRef} onClick={clickMakeGroup}>Ավելացնել</button> {apiResponse}
            </div>
